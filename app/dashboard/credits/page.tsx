...
const REASON_CONFIG: Record<string, { label: string; icon: any; color: string; bgColor: string }> = {
  SIGNUP: { label: "Welcome Bonus", icon: Gift, color: "text-emerald-500", bgColor: "bg-emerald-500/10" },
  PURCHASE: { label: "Credit Purchase", icon: ShoppingCart, color: "text-blue-500", bgColor: "bg-blue-500/10" },
  GENERATION: { label: "Itinerary Generated", icon: Zap, color: "text-orange-500", bgColor: "bg-orange-500/10" },
  EXPORT: { label: "PDF Export", icon: FileText, color: "text-purple-500", bgColor: "bg-purple-500/10" },
  REFUND: { label: "Refund", icon: RotateCcw, color: "text-teal-500", bgColor: "bg-teal-500/10" },
};
    ...
    <div className="max-w-5xl space-y-10">
      ...
      >
        ...
        <Card className="relative overflow-hidden border-border/50 bg-gradient-to-br from-orange-600 via-orange-500 to-orange-400 p-8 text-white col-span-1 sm:col-span-1 rounded-[2rem] shadow-[0_20px_50px_-15px_rgba(234,88,12,0.4)]">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-sm font-bold text-orange-100 uppercase tracking-wider">Balance</p>
            </div>
            <h2 className="text-5xl font-black tracking-tight">{credits ?? "..."}</h2>
            <p className="text-xs text-orange-200 mt-2 font-medium">Credits available</p>
          </div>
        </Card>
        ...
        <Card className="relative overflow-hidden border-border/50 bg-card/40 backdrop-blur-sm p-8 rounded-[2rem]">
          <div className="flex items-center gap-3 mb-4">
            ...
            <p className="text-sm font-bold text-muted-foreground uppercase tracking-wider">Earned</p>
          </div>
          <h2 className="text-4xl font-black tracking-tight text-foreground">+{totalEarned}</h2>
          <p className="text-xs text-muted-foreground mt-2 font-medium">Total credits received</p>
        </Card>
        ...
        <Card className="relative overflow-hidden border-border/50 bg-card/40 backdrop-blur-sm p-8 rounded-[2rem]">
          <div className="flex items-center gap-3 mb-4">
            ...
            <p className="text-sm font-bold text-muted-foreground uppercase tracking-wider">Used</p>
          </div>
          <h2 className="text-4xl font-black tracking-tight text-foreground">-{totalSpent}</h2>
          <p className="text-xs text-muted-foreground mt-2 font-medium">Total credits spent</p>
        </Card>
      </motion.div>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <Badge variant="secondary" className="bg-accent/40 text-muted-foreground border-none font-bold text-xs">
